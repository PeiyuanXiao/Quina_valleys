...
# Manuscript figure: topographic long profile along a traverse that visits every
# Quina site, with the sites sitting on the real ground surface.
#
...
# Liandong reach runs partly E-W, so latitude scrambles the along-valley order,
# which is what scripts/maps/03_elevation_profile.R does). The three transects
# are then chained end to end, nearest end first.
#
...
# cross-valley swath of liandong_section_figure.R: a swath shows the
