...
# Illustrator, matching the draft composition:
#
#   +----------------------+---------------------+
...
#
# Output (output/figures/fig01_panels/):
#   panel_A_map.png/.pdf              81 x 100 mm, no legend
#   panel_A_map_with_route.png/.pdf   same, plus the panel C traverse route
#   panel_C_profile.png/.pdf         146 x  54 mm, no legend
#   legend.png/.pdf                   shared legend, on its own
