## 08_terrain_3d.R — oblique 3-D view of the Binchuan and Heqing basins.
##
## Companion to 01_map.R: same DEM, same site table, same channel network, same
## hypsometric palette, so the 3-D panel and the plan map read as one figure.
...
## ---- palette (identical to 01_map.R, including the paper blend) -----------
...
rgl::close3d()
message("08_terrain_3d.R done -> ", out_png)
