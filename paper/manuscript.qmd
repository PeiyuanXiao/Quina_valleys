...
keywords:
  ...
  - Quina landscape
abstract: |
  Whether Middle Palaeolithic technological variability reflects cultural traditions or shared responses to environmental pressures remains a central question in human evolution. Quina is a technological system built around thick, asymmetric blanks, prolonged resharpening and a ramified chaîne opératoire, and has been linked to high mobility in seasonally structured landscapes. In Europe, it is documented mainly between MIS 4 and the early MIS 3, and the full Quina system was recently identified at Longtan, on the southeastern margin of the Tibetan Plateau. Here we show that Longtan was not an isolated case: the Quina toolkit recurs across the regional landscape. The 166 Quina scrapers and 58 resharpening flakes collected from 27 surface localities are technologically consistent with the excavated assemblage, while both differ significantly from non-Quina scrapers at Longtan. Trachyte was consistently selected regardless of its local abundance, likely because of its large size and predictable fracture properties. Quina scraper features varied among localities, but this variation was not explained by basin, height above the channel, or distance from it. Although this dry-hot valley system differs markedly from the settings of the European Quina, its relief creates a comparable ecological problem: patchy, seasonally organised resources distributed across heterogeneous terrain and requiring movement through the landscape. Quina in East Asia may therefore reflect a response to similar ecological conditions, although whether this reflects independent technological convergence or diffusion remains open.
editor_options:
...
- First regional Quina system in East Asia; Longtan is no longer an isolated case.

- Quina toolkit from surface collections is technologically consistent with Longtan.

- Trachyte was chosen for cobble size and predictable fracture, not local abundance.

- Quina scraper characteristics show no systematic variation with landscape position.

- Similar ecological structures in distant regions may favour behavioural convergence.

# Introduction

The Middle Palaeolithic (\~300–40 ka) was a period of marked diversity in lithic technology [@delagnes2006; @delagnes2007technocomplexes]. This variability has been attributed to a range of factors, including cultural traditions [@bordes1950; @bordesMousterianCulturesFrance1961], site function [@binfordbinford1966], environmental pressures [@kuhn1995], raw material affordance [@geneste1985; @turq1992] and reduction intensity [@dibble1987interpretation; @hiscock2007; @hiscock2008construction], with the debate increasingly moving towards more integrated explanations [@rollanddibble1990; @faivre2017; @Kuhn2020Moving]. However, whether East Asia has a Middle Palaeolithic at all has long been contested. On the conventional view, innovation in lithic technology was deferred until the Upper/Late Palaeolithic, leaving no phase corresponding to the western Middle Palaeolithic [@gaoPaleolithicCulturesChina2013; @norton2009eastasian]. Recent discoveries have provided new evidence that is reshaping this long-standing view. Discoid technology is documented at Lingjing (\~125–90 ka) [@liTechnologicalBehaviorEarly2019], and Levallois technology at Guanyindong (\~170–80 ka) [@huLateMiddlePleistocene2019] and Jinsitai (\~47–37 ka) [@liEasternmostMiddlePaleolithic2018]. These finds indicate that the technological scenario of the East Asian Middle Palaeolithic is more complex than the conventional view allows.

The Quina is one of the best-defined Middle Palaeolithic techno-complexes in Europe, characterised by highly flexible behaviour, with reduction strategies adapted to a variety of blanks [@Bourguignon1997; @turq2000; @delagnes2007technocomplexes; @delpiano2022]. Knappers produced thick flakes with markedly asymmetric cross-sections, maintained working edges through Quina retouch, and ramified their *chaînes opératoires*. Strictly defined, the Quina system has so far been documented only in western and southern Europe, mainly during MIS 4–3 [@frouinDatingMiddlePaleolithic2017; @guerin2017RocDeMarsal; @peresani2023; @yu2026DeNadale], whereas Quina retouch considered in isolation has a far broader spatial and temporal distribution [Levant, MIS 11; @FALGUERES2022101266; @lemoriniScrapersLifeHistory2016]. Neither the Quina system nor Quina retouch, however, had previously been securely documented in East Asia. Against this background, the identification of a complete stone tool production system at Longtan in northwest Yunnan, southwest China, dated to \~60–50 ka [@ruanQuinaLithicTechnology2025a], represents the first Quina site in East Asia to be formally excavated, securely dated, and systematically characterised. This discovery not only filled a long-standing gap in the eastern Old World distribution of Quina technology, but also provided new evidence for reassessing the diversity and complexity of the East Asian Middle Palaeolithic.

More importantly, Longtan is unlikely to be an isolated case. Surface collections of stone artefacts with Quina features have been recovered at a number of localities in the Huangping Basin, where Longtan is situated, and in the neighbouring Binchuan Basin, most of them on river terraces [@ruanQuinaLithicTechnology2025a; @xiao2024survey], and Quina-like scrapers had earlier been reported from Tianhua Cave in the Huangping Basin [@hu2020Tianhuadong]. These finds suggest that Quina technology on the southeastern margin of the Tibetan Plateau may not be confined to a single site, but may instead represent a regional technological phenomenon of some spatial extent. These basins lie in the Hengduan Mountains, in what is today the dry-hot valley zone of the Jinsha River drainage, a setting quite unlike those in which Quina technology has previously been documented. How this environmental context relates to the occurrence of Quina technology remains an open question. All of the localities so far identified, moreover, apart from Longtan itself, are surface collections, and only one of them, Tianhua Cave, has been dated, by OSL on a test trench in front of the cave [@hu2020Tianhuadong], so that whether they constitute a coherent regional technological entity is equally open.

The aim of this paper is to determine whether the Quina surface collections of the Huangping and Binchuan basins share the technological concept documented from the materials excavated from Longtan, and to characterise the regional entity. We first ask whether Quina scrapers from the surface collections share the technological attributes of those excavated at Longtan, with resharpening flakes providing complementary evidence. We then ask how this regional entity was organised across the landscape, including which stone was selected relative to what was available and whether technological variation correlates with landscape attributes. Finally, we consider what technological problem Quina may have addressed in this setting. Drawing on published environmental evidence, we propose technological convergence as a possible explanation while leaving the question of origin open.

# The Quina system: definition and analytical framework

Quina was initially defined by Bordes as a subtype of the Charentian Mousterian, but was later recognised as a distinct technological system as understanding of its underlying technological concept deepened. Based on current research, the Quina system can be characterised by three interrelated elements [@bourguignon1996conception; @Bourguignon1997; @delpiano2022].

The first element is blank production. Quina cores receive limited preparation and are reduced through alternating, concatenated removals on sub-parallel and secant surfaces, with invasive detachments that optimise the volume of stone converted into blanks [@turq1989; @turq2000; @Bourguignon1997]. The target product is a thick flake, asymmetric in cross-section, with a sharp cutting edge on one margin and a thick, often cortical, back opposite. Asymmetry and thickness are what allow such a tool to be repeatedly resharpened [@turq1992; @hiscock2009]. Core reduction also produced a wide range of flakes with less controlled morphologies and more limited thickness.

The second element is edge maintenance, achieved through Quina retouch. Here the working edge is not merely produced but sustained, and resharpening follows a regular pattern [@lemoriniScrapersLifeHistory2016; @Bourguignon1997]. Early episodes detach relatively large flakes and leave convex scars, giving a plano-convex edge and preserving volume for later work; as retouch proceeds it concentrates on the margin itself, producing smaller concave scars with stepped or hinged terminations and a plano-concave edge that keeps the tool serviceable. Each generation of retouch therefore restores a working edge without drawing on new raw material.

The third element is ramification of the *chaînes opératoires* [@bourguignon2004ramification; @faivre2017]. Resharpening flakes detached during edge maintenance carry cutting edges of their own and can be used directly, as use-wear analysis has shown [@claud2012; @delpiano2022]; in some cases they were themselves marginally retouched into tools [@ruanQuinaLithicTechnology2025a]. Quina flakes, besides being shaped into Quina scrapers, are thick enough to serve as cores for small flakes (i.e. core-on-flake) [@hiscock2009]. Use-wear on scrapers and resharpening flakes from the same assemblages indicates that the two were put to different tasks, scraping and cutting respectively [@delpiano2022], so that ramification widened the functional range of the toolkit as well as extending its life.
...
[Difference tests.]{.underline} To assess technological consistency, Quina scrapers from Longtan were used as the reference group and non-Quina scrapers from the same site as a control. Six variables were selected for multivariate analysis to represent the recorded technological dimensions most sensitive to Quina scraper technological variation, while limiting redundancy: thickness, proportion of the perimeter retouched, GIUR, total scar count, retouch generations and edge angle. Variables were z-standardised and compared using Euclidean distances. Thickness was retained as the sole size-related variable because it has greater technological relevance to Quina, while additional size measures would redundantly weight size variation in the Euclidean distance space. A Principal Components Analysis (PCA) of that same standardised matrix is used to display the space and to report how the six variables load on its first components (Table S6). This PCA is exploratory only, our inferences below are drawn from the distances themselves rather than from the PCA projection. Group differences were tested with PERMANOVA [@anderson2001new], with *R*² reported for pairwise comparisons, and dispersion measured with PERMDISP [@andersonDistanceBasedTestsHomogeneity2006]. Because PERMANOVA reads a group difference as a difference in position only on the assumption that the groups are equally dispersed, we also repeated every pairwise comparison with the Welch-type *W*~d~\* statistic, which weights each group by its own dispersion instead of pooling them, and so does not have that assumption of equal dispersion [@alekseyenko2016; @hamidi2019]. At the univariate level, we compared GIUR, total scar count and retouch generations with Kruskal–Wallis tests followed by Dunn's post hoc tests, while thickness, proportion of the perimeter retouched, and edge angle were compared with Welch's ANOVA followed by Welch's *t*-tests; all post hoc comparisons were Bonferroni-corrected. Test distributions are shown in Fig. S3.

Variation in thickness and edge angle was assessed using coefficients of variation and the Krishnamoorthy–Lee modified signed likelihood ratio test (KL-MSLRT) [@krishnamoorthy2014; @marwick2019cvequality]; GIUR, proportion of the perimeter retouched and total scar count were instead compared using Fligner–Killeen tests [@fligner1976]. Retouch generations is the mean over a specimen's edges and takes too few distinct values for a dispersion ratio to be informative, and so we excluded it from the dispersion comparisons.

[Equivalence tests.]{.underline} The traditional null hypothesis significance tests described above assume that there is no difference between groups and look for evidence to reject this. However, failing to reject the traditional null hypothesis does not statistically prove that no difference exists, because our test might simply have lacked the statistical power to detect a true effect [@lakens2018; @tomekBeyondNonsignificantResults2026]. Equivalence testing addresses common misinterpretations of non-significant p-values as the absence of an effect by allowing us to reject effects large enough to be considered meaningful [@robinson2004model]. To put a bound on what to take as a meaningful difference between the surface-collected and Longtan Quina scrapers, we expressed it as a fraction of a difference whose technological meaning is already established, that between the Longtan Quina scrapers and the non-Quina control. For each variable, on its own units, we computed the surface–Longtan gap, expressed as a fraction of the Quina/non‑Quina gap, using this difference ratio (*DR*)

$$\mathit{DR} = \frac{\left|\,\mathrm{mean}(\text{surface-collected Quina}) - \mathrm{mean}(\text{Longtan Quina})\,\right|}{\left|\,\mathrm{mean}(\text{Longtan Quina}) - \mathrm{mean}(\text{Longtan non-Quina})\,\right|}$$

The multivariate counterpart is the same ratio formed from the Euclidean distances between group centroids in the six-variable z-standardised space used above. On this scale *DR* = 1 is the point at which the two Quina groups would differ from one another as much as Quina differs from non-Quina, so that *DR* measures the difference between the surface-collected and Longtan groups in units of a difference the analysis has already shown to be substantial.

Uncertainty in *DR* was estimated by bootstrap. Because the surface-collected scrapers were recovered from `r n_localities` localities and there are not as many independent observations as they are specimens (the landscape model described below places the locality share of the variance at about a fifth for both thickness and scar count), the surface-collected group was resampled by locality, whole localities drawn with replacement and each with all of its specimens, while the two Longtan groups were resampled by specimen. Five thousand replicates gave the one-sided 95% upper bound on *DR*, and twenty thousand replicates gave the equivalence *p*-value curve *p*(Δ). From this curve we can see the proportion of replicates with *DR* ≥ Δ, so that equivalence at a bound Δ holds when *p*(Δ) ≤ α (Fig. S5). The quantity we report is the 95% upper bound, equivalently the smallest Δ at which that curve reaches *p* = 0.05. As a sensitivity analysis, the comparison was repeated using the classical TOST method [@lakens2017], treating specimens as the independent unit without accounting for locality (Table S7).

## Raw materials and landscape analysis

### Survey and analysis of raw materials

To characterise locally available raw materials, gravel bars were sampled at five points along three river channels (@fig-geology; Fig. S6). At each point, a 1–2 m² area was cleared and all surface cobbles longer than 30 mm recorded. Length, width, thickness, roundness and field-assigned shape were recorded for each cobble (Tables S12–S14). Roundness and the field-assigned shape were not analysed here due to inconsistencies in recording protocols. For quantitative form analysis, the three axes were ordered as a ≥ b ≥ c and treated as compositional data, making form comparisons independent of size [@aitchison1986; @egozcue2003]. Form was compared between lithologies using PERMANOVA on Aitchison distances, with PERMDISP testing dispersion [@andersonDistanceBasedTestsHomogeneity2006]. Cobbles were also plotted on the Sneed–Folk ternary diagram [-@sneed1958], with contours of maximum projection sphericity
...
where *r* is the proportion of a given raw material among the artefacts and *p* is its proportion among the cobbles recorded in the gravel survey. *D* ranges from −1 (used far less than expected) through 0 (no preference, used exactly as often as it is available) to +1 (used far more than expected). This was computed for each raw material in the surface-collected Quina scrapers against availability pooled across the gravel survey. Where either proportion is zero the index saturates: a material absent from the gravel survey returns *D* = +1, and one absent from the artefacts returns *D* = −1, whatever the value of the other proportion. In these cases, *D* records the direction of the selection but not its strength. A zero in the gravel survey is thus a sampling zero rather than a demonstrated absence. Such values are reported for completeness but should not be interpreted on the same scale as those computed from two non-zero proportions.

### Landscape-level analysis of technological structure

To assess whether landscape position structured technological variation, we used a Bayesian multivariate multilevel model. This framework was chosen because the data comprise individual Quina scrapers, each with seven variables, nested within `r n_localities` unequally-sampled and unequally-sized localities (ranging from 1 to 49 specimens each). This requires explicit estimation of locality-level variance and its uncertainty rather than treating specimens as independent observations. Bayesian hierarchical models employ partial pooling, borrowing strength across groups to stabilise estimates for small clusters [@gelmanHill2007; @mcelreath2020]. Furthermore, the Bayesian framework naturally quantifies the proportion of variance attributable to locality-level differences [@gelman2006bayesian]. Our goal was to assess whether landscape effects were practically negligible, which a posterior distribution combined with a region of practical equivalence (ROPE) can do by accepting, rejecting, or reporting undecided verdicts [@kruschke2018rejecting]. Sharing one 7×7 locality covariance matrix across all seven responses is more efficient than seven separate models and properly propagates the fact that the same `r n_localities` localities contribute data to every measure.

The seven technological measures were modelled jointly at the individual-scraper level, with locality included as a multivariate random intercept. The response set comprised thickness, overall size (the geometric mean of length, width, and thickness), GIUR, proportion of the perimeter retouched, total scar count, edge angle, and retouch generations. Overall size was included in the landscape model to capture variation in general Quina scraper size, while thickness was retained because of its more direct technological relevance to Quina. Their covariance was explicitly estimated in the multivariate model. Responses were assigned likelihoods appropriate to their measurement scales: log-normal for thickness and size, zero-one-inflated beta for GIUR and proportion of the perimeter retouched, negative binomial for scar count, and Gaussian for edge angle and retouch generations. Because retouch generations is the mean across up to three retouched edges per specimen, it can take fractional values rather than integer counts; we therefore modelled it with a Gaussian likelihood. The model included three locality-level landscape predictors: basin, height above the channel, and distance to the channel, with the two continuous predictors z-standardised across specimens. Height above the channel was used instead of terrace category or absolute elevation because it is a continuous, locally referenced measure that is less sensitive to differences in basin base level.

The analysis addressed two questions in sequence. First, do localities differ technologically? We estimated the locality-level variance and corresponding intraclass correlation coefficient (ICC) and compared these with an intercept-only model to assess whether the landscape terms absorbed substantial between-locality variation. Second, do the landscape variables explain these differences? We evaluated the 21 landscape slopes after standardising each by the SD of its response on the corresponding link scale, using a region of practical equivalence (ROPE) of ±0.1 response-specific link-scale SD. Full model specification, prior and predictive checks, convergence diagnostics, and prior sensitivity analyses are reported in Supplementary material 2 following @kruschke2021's Bayesian Analysis Reporting Guidelines.

## Sensitivity analyses

Sensitivity analyses addressed the main sources of sampling and model uncertainty associated with the locality-based surface collection and uneven group sizes. For the comparison with Longtan, we conducted leave-one-out analyses, removing all surface specimens from each locality in turn and repeating the pairwise comparisons. Standardisation and ordination were fixed to the full dataset so that the technological space remained unchanged across iterations (Fig. S4). For raw material selection, Jacobs’ D was recomputed after excluding each gravel sampling point and each valley in turn, as well as using each sampling unit separately (Fig. S8); the artefact proportion was held at its region-wide value, while raw material availability was allowed to vary. These tests are reported in Supplementary material 1. For the Bayesian model, we varied the reference priors across six alternative specifications, including the slope prior, locality-level standard deviation priors, and the correlation prior, and additionally refitted retouch generations using a log-normal likelihood and the landscape terms with a separate height and distance slope for each basin. These are reported in Supplementary material 2.

## Reproducibility and open materials

Computational reproducibility remains a challenge in archaeological science, but it is essential for assessing the reliability of quantitative results and enabling their reuse by other researchers [@marwickComputationalReproducibilityArchaeological2017; @marwick2017openscience; @marwick2018packaging]. All analyses in our study were carried out in `r version$version.string` [@R-base]. Package versions (Table S1), permutation, Monte Carlo and bootstrap settings, and the random seed are reported in Supplementary material 1. To facilitate reproducibility, all materials required to reproduce the analyses reported here are available in an openly archived research compendium at <https://doi.org/10.17605/OSF.IO/PGWY2>, following established recommendations for reproducible data analysis workflows in R [@marwick2018packaging]. The repository includes the raw data underlying all reported results and the complete analysis code. It is organised using a logical self-contained folder structure and relative file paths, allowing the code to run without manual modification.
...
The `r n_scraper` Quina scrapers from the surface collections are consistent with the Quina technological concept in each of its three elements: in blank selection, in edge maintenance, and in ramification (Table S2).
...
#| tbl-cap: "Attribution of the surface-collected Quina scrapers within Bordes' type list, grouped by type family. The triple scraper is not a type of Bordes' list and is entered without a number."
...
[Ramification sequence.]{.underline} Two groups of specimens record modification carried out on pieces that had already served as tools. Because these are surface collections, we cannot assess how much of the reduction sequence these observations represent, and we describe them here as technological behaviours attested on individual specimens rather than as evidence for the structure of production as a whole.

The first group is characterised by the presence of "Clactonian notch" removals struck from the retouched edge, recorded on fourteen Quina scrapers (8.43%): broad, invasive scars, markedly deeper than those of the retouch generations described above. At Fumane Cave such removals are read as the expression of a distinct branching modality, in which the notch simultaneously detaches a usable blank and reconfigures the working edge of the scraper [@peresani2023].

The second group is characterised by specimens whose ventral face preserves flaking scars underlying to the Quina retouch, among them three of the four *limaces* (@fig-quina-scrapers-2). On these pieces the same volume served both as a flaking matrix and as a retouched tool. Comparable specimens are central to the *outils-matrices* of the Aquitaine assemblages [@bourguignon2004ramification] and to the "mixed-matrix" core-tools of De Nadale Cave, where *limaces* combine the volumetric criteria of Quina reduction with the functional attributes of retouched tools [@delpiano2022].
...
Now that we have established that the surface-collected Quina scrapers are consistent with the Quina system, we compare them to the Longtan Quina scrapers to evaluate if the surface finds differ from the excavated materials. We found that the surface-collected Quina scrapers are indistinguishable from the excavated Quina scrapers at Longtan (*n* = `r ltq_n`), but both are clearly separated from the non-Quina scrapers (*n* = `r lto_n`) that we used as a control. In the six-variable technological space, PERMANOVA finds no difference between the two Quina groups (*R*² = `r f(tc_scltq_R2, 3)`, pseudo-*F* = `r f(tc_scltq_F, 2)`, *p* `r fp(tc_scltq_p)`), while each differs strongly from the non-Quina scrapers, with an order of magnitude more explained variance (*R*² = `r f(min(tc_nonq_R2), 2)`–`r f(max(tc_nonq_R2), 2)`, pseudo-*F* = `r f(min(tc_nonq_F), 1)`–`r f(max(tc_nonq_F), 1)`, *p* `r fp(tc_nonq_p)` in both cases) (@fig-technological-consistency; Table S3).

The non-Quina scrapers are also the less dispersed group, so that separation could in principle follow from unequal spread rather than from position. We specifically assessed this with the Welch-type *W*~d~\* statistic, which weights each group by its own dispersion instead of pooling them. The results show that both contrasts hold (*W*~d~\* = `r f(min(wds_nonq_stat), 1)`–`r f(max(wds_nonq_stat), 1)`, *p* `r fp(wds_nonq_p)` in each case), and the two Quina groups remain indistinguishable (*W*~d~\* = `r f(wds_scltq_stat, 2)`, *p* `r fp(wds_scltq_p)`).

```{r}
#| label: fig-technological-consistency
#| fig-cap: "Technological consistency of surface-collected Quina scrapers with the excavated Longtan Quina scrapers, against Longtan non-Quina scrapers as a control, on six technological variables. (A) PCA of the z-scored technological space, with convex hulls, group centroids, variable loadings, and marginal histograms of the PC1 and PC2 scores by group. (B) Per-variable distributions with pairwise post-hoc brackets."
#| fig-width: 5.9
#| fig-height: 8.07
...
The univariate results reinforce this pattern with none of the six variables differing between the two Quina groups, whereas all six can distinguish each Quina group from the non-Quina scrapers (@fig-technological-consistency; Table S5). The bootstrap equivalence-bound test on *DR* further quantifies the magnitude of this similarity, indicating that the multivariate difference between the surface-collected and Longtan Quina groups at the locality-level is at most approximately `r eq_UB95_pct`% of the difference between the Quina and non-Quina groups, even after accounting for sampling uncertainty. As a specimen-level cross-check on equivalence, the Welch form of TOST gives narrower intervals than the locality-level analysis and finds equivalence on five of the six measures, so the conclusion does not hinge on the locality-level resampling (Table S7). Thus, the difference between the two Quina groups remains well below one-third of a meaningful between-group difference, providing quantitative support for their equivalence.
...
#| tbl-cap: "Univariate dispersion of the surface-collected Quina scrapers against the Longtan Quina scrapers. Each family is summarised by the dispersion measure appropriate to its scale of measurement and tested by the corresponding procedure; the ratio is surface-collected over Longtan, so that one denotes equal dispersion, and its interval is a bootstrap percentile interval. The statistic is the MSLRT for the coefficient of variation and the Fligner–Killeen chi-squared elsewhere."
...
# The Bayesian model comes from the pipeline. Nothing is sampled during a
# render and nothing can be stale: tar_make() refits whatever the data or the
# priors have invalidated before it renders this document. The context keeps
# its own name because barg_data.R defines mod_dat, ROPE_SD and variables,
# names _analysis.R also uses for its own versions of the same things.
tar_load(c(ctx_report, fit_ref, fit_noland, fit_prior_ref), store = TAR_STORE)
barg <- ctx_report

land_ref <- fit_ref        # the three landscape terms
land_nol <- fit_noland     # intercept only, for the comparison
land_pri <- fit_prior_ref  # prior-only, for the prior/posterior width in Fig. 9B
...
Whether or not landscape variables had structural influences on lithic technology first requires that technological differences exist among localities. Our Bayesian model shows that such differences do exist for three scraper attributes. Quina scraper size, thickness and total scar count show correlations with locality that exclude the region of practical equivalence (@fig-landscape-model). Locality-level variation accounts for `r icc_pct("GMsize", TRUE)` of the variation in Quina scraper size, `r icc_pct("NScar")` in total scar count, and `r icc_pct("Thickness")` in thickness. These `r num_word[nrow(icc_present)]` measures have credible intervals well above our 5% practical‑significance cutoff for locality effects, below this value we consider an effect negligible. For the other `r num_word[nrow(icc_undec)]` traits, the data are inconclusive: the locality share could be near zero or substantial, and our design cannot tell which (@fig-landscape-model panel A; @tbl-landscape-icc; Table S15). Thus, differences among localities are expressed mainly in the dimensions of Quina scrapers.

```{r}
#| label: fig-landscape-model
#| fig-cap: "Landscape structure of technological variation. Results from the Bayesian multivariate multilevel model showing (A) the proportion of variance attributable to among-locality differences and (B) standardised effects of basin, height above the channel, and distance to the channel across seven technological measures. Shading indicates negligible variance components in (A) and the region of practical equivalence (±0.1 standard deviations) in (B)."
#| fig-width: 7.5
#| fig-height: 3.4
#| out-width: "5.9in"

barg$barg_main_figure(land_ref, land_pri, land_nol)
```

The three landscape variables, however, do not explain these differences. If basin, height above the channel and distance to the channel influenced the between-locality signal, the locality share of the variance would fall when the landscape terms enter the model. @fig-landscape-model panel A shows it mostly does the opposite and increases. The median change across the seven measures is `r sprintf("%+.0f", 100 * med_rel)`% of the intercept-only value, `r num_word[n_icc_up]` of the seven rising and `r num_word[n_icc_dn]` falling, a pattern scattered about zero rather than a reduction (@tbl-landscape-icc). The individual coefficients lead to the same conclusion: none of the `r n_slopes` effects provides clear evidence of a directional relationship between artefact attributes and landscape variables, although most remain uncertain given that these predictors vary among only `r n_localities` localities rather than among individual specimens (@fig-landscape-model panel B; Supplementary material 2). Because a landscape effect could in principle be present in one valley and absent in the other, we also refitted the model with a separate height and distance slope for each basin; the two basins could not be distinguished, although the Huangping slopes lean uniformly positive and a larger sample there might resolve them (Supplementary material 2).
...
Quina scrapers therefore vary among localities, but that variation is not explained by basin, height above the channel, or distance to the channel at the resolution of the present dataset. Despite substantial differences in local raw material availability, raw material selection was remarkably consistent across the study area; the source of the remaining technological variation therefore lies outside the three landscape variables tested here.

# Discussion

## The Quina system and its landscape organisation

The Quina material from these two basins is the product of a single technological concept, with surface finds indistinguishable from the stratified artefacts. The primary evidence is technological: the scrapers show the diagnostic attributes of the Quina system, including thick, asymmetric blanks, successive generations of retouch, regular alternation of convexity and concavity scars, and continued production of resharpening flakes. On the measures informative on these attributes, no difference is detected between the surface-collected Quina scrapers and the excavated Longtan Quina material, while the same measures separate both from the non-Quina scrapers. Locality-level resampling shows that any multivariate difference between the surface-collected and Longtan Quina groups is at most `r eq_UB95_pct`% of the difference between Quina and non-Quina scrapers at Longtan. The two Quina groups also show similar dispersion, both overall and across individual variables. Together, these results indicate that the surface collections are not merely superficially similar, but represent the repeated application of a shared technological concept across a range of regional landscapes.

Longtan is therefore no longer a single case. The claims of Quina there have been questioned by @Bourguignon2025QuinaChina and answered by @RuanEtAl2025. Part of that exchange concerned the position taken in the original report on origins, which had in fact been left explicitly open by @ruanQuinaLithicTechnology2025a, with context-specific convergence advanced as a plausible hypothesis. In reply to @Bourguignon2025QuinaChina, @RuanEtAl2025 further showed how the interdependence of flaking, retouch and ramification supports a technological system rather than a merely typological category, together with the proportion of grains accepted by the Bayesian OSL model and the sedimentological evidence for *in situ* deposition in Layer 3. The exchange nonetheless concerned whether a single assemblage represents a once-off chance expression or a repeated pattern of shared behaviours, and it is on that point that the present study makes an important contribution. Across several valleys and several terrace levels in two basins, assemblages appear that are consistent with Longtan in raw material selection, in blank selection, in the manner of retouch and in the degree to which tools were reduced. What the surface collections establish is that a technological concept consistent with that represented at Longtan is clearly distributed across the broader, geographic area. Without independent chronological control, the evidence currently establishes only the spatial distribution of this technology, rather than its chronological framework. This finding holds whether or not its affinity with the European Quina is granted.

The organisation of this technology in the landscape surrounding Longtan was selective and uniform. The localities occupy the lower terraces of the valley systems and lie close to the channels, at a median of a few hundred metres, so that the gravel bars rather than the bedrock outcrops were the source of knappable stone throughout, and access to them was broadly comparable across the study area. What was collected on those gravel bars to be shaped into artefacts was not the raw material that lay most abundantly upon them. Trachyte was selected and sandstone rejected, regardless of local abundance. The same choice was made in every valley although the composition of the bars differs significantly between them.

Technological consistency does not imply the absence of within-group variation. Our Bayesian model shows that technological differences do occur among localities, with locality accounting for `r icc_pct("GMsize")` of the variance in overall Quina scraper size, `r icc_pct("NScar")` in total retouch scar count, and `r icc_pct("Thickness")` in thickness, the three measures whose credible intervals lie wholly above the threshold for negligible locality-level variation. Given the association between total scar count and blank size, these differences appear to primarily reflect how knappers selected blanks of different sizes, rather than the specific retouching strategies they used. What the model does not show is any clear landscape structure to this variation. Basin, height above the channel, and distance to the channel do not account for a meaningful reduction in locality-level variance. None of the `r n_slopes` estimated slopes shows a clear directional relationship. This result should nevertheless be interpreted at the scale sampled here: these landscape predictors vary among `r n_localities` localities, and the limited number of localities constrains inference, with several posterior estimates remaining close to their priors. In our study area, distances to the nearest channel vary by only a few hundred metres among localities. This is well below the spatial scale at which previous studies have detected gradients in stone tool curation associated with distance from raw material sources, which are typically on the order of several to tens of kilometres [@Kuhn2020Moving; @Pop2022Evaluating; @Beck2002Rocks]. Thus, at the spatial scale sampled here, the analysis provides no evidence that landscape position organises technological variation among localities. This does not mean that such organisation is entirely absent, only that the spatial scale of our study area is likely too small to detect these differences. Across two basins, three valleys and several terrace levels, the most striking pattern is therefore one of a shared technological concept expressed through local variation in blank size, without a clear spatial structuring by landscape position.
...
The European and East Asian Quina settings share a specific resource structure. Resources were organised seasonally and partitioned by relief, by the topographic separation of plateau, valley and plain in southwestern France [@delpechLenvironnementAnimalMousteriens1996] and by the altitudinal zonation of water, vegetation, and faunal resources in our study area [@jiangSeasonalDynamicsSoil2024; @liUsingLargeSpatial2018]. Such spatial and seasonal structuring favoured hominin movement between resource zones. The selection of trachyte is consistent with this resource structure. The properties that recommended it over sandstone (Section 5.2) also support prolonged reduction and repeated resharpening, enabling tools to remain functional over extended use away from raw material sources. A shared problem of this kind provides a mechanism for technological convergence, allowing hominin populations with no contact to arrive at functionally similar solutions. The resemblance in resource structure of these geographically remote regions explains why the presence of Quina in this landscape should be expected rather than a surprise.

A comparable case of recurrence is documented outside East Asia. In the Levantine Acheulo-Yabrudian, Quina retouch occurs together with blanks produced by methods similar to those of Quina flaking [@Bourguignon1997]. How closely these assemblages correspond to the Quina system as defined in Europe has not, however, been examined in comparable detail, and we therefore take a conservative position and do not treat them here as a further instance of that system. The Levantine case is nevertheless relevant to questions of origin: although West Asia lies between the two regions considered here, the Levantine occurrence predates the European Quina system by more than 100,000 years and does not continue into the subsequent Levantine Middle Palaeolithic. It thus provides no plausible chronological bridge between them, and instead illustrates that Quina retouch, together with a comparable approach to blank production, can recur without a demonstrated connection.

Several elements of our interpretation remain untested by the present material. The European argument runs from prey structure through mobility to technology and is demonstrated by archaeological faunal assemblages. In contrast, the evidence for faunal resource partitioning in our study area comes from modern ecological data rather than contemporaneous fauna. No faunal remains of this period have been recovered from our study area, so the mobility inferred here from the landscape and its present-day resource structure cannot yet be more directly observed. Nor can the settlement system documented in southwestern France, with seasonally relocated camps and hunting and processing locations as satellites [@delagnesShiftsNeandertalMobility2011], be recovered from our surface collections.

## Regional implications

Our findings also bear on a longer-standing question about the East Asian Middle Palaeolithic. The recent recognition of Levallois and Discoid technology in China has already made it difficult to maintain that lithic technology was lacking innovation before the Upper/Late Palaeolithic [@huLithicTechnologiesGuanyindong2024; @ruanQuinaLithicTechnology2025a; @liEasternmostMiddlePaleolithic2018; @liTechnologicalBehaviorEarly2019]. The Quina system at Longtan adds another technological pattern to that scenario, and what the present study contributes is that this technology is not an isolated, single-site occurrence, but a way of working stone applied consistently across a region.
...
Our results do not rule out diffusion as a process by which Quina originated in China. The Quina system in Europe is closely associated with Neanderthals, and the boundaries of their range continue to be revised. Isolated reports of Quina-like material from Central and northern Asia, including Azykh Cave in Azerbaijan and the Denisova Cave in the Altai, although still requiring further substantiation, further broaden the geographical context in which dispersal remains a possibility [@birtwistleSearchLowerMiddle2018; @brownEarliestDenisovansCultural2022]. These observations do not demonstrate a population movement into East Asia, but they caution against excluding such a possibility a priori. At this stage, therefore, whether the presence of Quina in East Asia can be taken to indicate a Neanderthal dispersal into the region is best left open, rather than being used to support a strong inference either way.
...
**Pei-Yuan Xiao:** Conceptualization, Methodology, Software, Formal analysis, Investigation, Data curation, Visualization, Writing – original draft. **Qi-Jun Ruan:** Conceptualization, Investigation, Resources, Data curation, Supervision, Writing – review & editing. **Davide Delpiano:** Methodology, Validation, Writing – review & editing. **Marco Peresani:** Methodology, Validation, Writing – review & editing. **Zhen-Xiu Jia:** Investigation, Writing – review & editing. **Li-Jing Yang:** Investigation, Resources. **Ming Zhang:** Investigation, Resources. **Jian Sun:** Investigation, Resources. **Ben Marwick:** Conceptualization, Methodology, Software, Formal analysis, Validation, Visualization, Supervision, Writing – review & editing. **Hao Li:** Conceptualization, Resources, Supervision, Project administration, Funding acquisition, Writing – review & editing.
...
This work was financially supported by the Archaeological Talent Promotion Program of China (No. 2025-198, to H.L.), the National Natural Science Foundation of China (Nos. U2574202 and 42471180, to H.L.), and the China Scholarship Council Program for International Students (CSC No. 202504910326, to P.-Y.Xiao).

# Data availability {.unnumbered}

All data and code needed to reproduce the results reported here are openly available, with no restrictions on access or reuse. The research compendium [@xiao2026compendium] is archived at <https://doi.org/10.17605/OSF.IO/PGWY2> under a CC BY 4.0 licence. The deposit holds the raw measurement records for the surface-collected Quina scrapers and resharpening flakes, the excavated Longtan retouched tools used for comparison, the river gravel survey and the locality table, together with the code that computes every number, table and figure in this paper and in Supplementary material 1 and 2.

# Acknowledgements {.unnumbered}

We are deeply grateful to Jian-Hui Liu, Research Curator at the Yunnan Provincial Institute of Cultural Relics and Archaeology, for his important contributions to field works, which provided essential support for the development of the dataset used in this study. We also thank Professor You-Ping Wang of Peking University for his support and guidance during the survey and the excavation of Longtan, as well as Professor Alexandra Sumner of DePaul University for her valuable assistance with specimen examination during the early stages of this study. This manuscript is based on a substantially revised version of Pei-Yuan Xiao's master's thesis submitted to the University of Chinese Academy of Sciences.
