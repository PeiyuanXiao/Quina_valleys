...
Our evidence supports a consistent regional entity with surface Quina scrapers that are indistinguishable from the Longtan material in the multivariate space of six technological variables, while both are distinct from the non-Quina scrapers at Longtan <!-- how about we add a fourth contrast, the non-Quina scrapers from the surface sites, as a second control? --> . Trachyte was consistently strongly selected and sandstone avoided despite differences in local gravel-bar composition, indicating that raw-material choice was governed by fracture quality and volume rather than abundance. Technological variation shows no systematic relationship with basin, distance or height above the channel, or assemblage size <!-- as I note above, I think we should split out assemblage size into another analytical block -->. The Quina technological concept was therefore deployed consistently and provisioned from the landscape in a uniform way across the study area.
