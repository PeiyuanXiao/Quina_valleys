...
keywords:
  ...
  - Quina landscape
abstract: |
  Middle Palaeolithic assemblages vary widely in technology, and whether this variability reflects separate cultural traditions or shared responses to environmental pressures remains a central question in human evolution. Among the most distinctive of these technologies is Quina, a system built around thick, asymmetric blanks and prolonged tool resharpening, associated with high mobility in seasonally structured landscapes. In Europe, Quina is documented mainly between MIS 4 and early MIS 3. In the eastern hemisphere, the complete system was recently identified at Longtan, on the southeastern margin of the Tibetan Plateau. The discovery of Longtan raises the question of whether it was an isolated event or part of a broader regional phenomenon. Here we show that the Quina toolkit in this region was not confined to a single site but recurs across an entire landscape. We compared 166 Quina scrapers and 58 resharpening flakes collected from the surface of 27 localities with the excavated Longtan assemblage, finding strong consistency between them, while both differed significantly from the non-Quina scrapers at Longtan. Trachyte was consistently selected despite its local abundance, likely because of its suitable size and predictable fracture properties. The features of Quina scrapers varied among localities, but this variation was not associated with basin, height above the channel or distance from it. This dry-hot valley system on the plateau margin differs fundamentally in latitude, climate and vegetation from the settings of the European Quina, yet its relief imposes an ecological challenge of the same structure: patchy, seasonally organised resources requiring movement through heterogeneous terrain. Thus, Quina may have emerged in East Asia as a response to similar ecological conditions, but whether through behavioural convergence or technological diffusion remains open.
editor_options:
...
# whole environment leaves all the inline references below working unchanged.
...
- Quina scrapers from `r n_localities` localities are technologically consistent with Longtan.
...
Computational reproducibility remains a challenge in archaeological science, but it is essential for assessing the reliability of quantitative results and enabling their reuse by other researchers [@marwickComputationalReproducibilityArchaeological2017; @marwick2017openscience; @marwick2018packaging]. All analyses in our study were carried out in `r version$version.string` [@rcoreteam2025]. Package versions, permutation, Monte Carlo and bootstrap settings, and the random seed are reported in Supplementary material 1. To facilitate reproducibility, all materials required to reproduce the analyses reported here are available in an openly archived research compendium at <https://doi.org/10.17605/OSF.IO/PGWY2>, following established recommendations for reproducible data analysis workflows in R [@marwick2018packaging]. The repository includes the raw data underlying all reported results and the complete analysis code. It is organised using a logical self-contained folder structure and relative file paths, allowing the code to run without manual modification.
